...
{ // Quand tu tapes localhost:8080/ il te renvoie index.html qui est situé dans le dossier client
...
{ // Chaque client a une valeur de client.id differente 

	client.on('pseudo', function (pseudo) 
	{ // Quand il reçoit un pseudo il le renvoit à tout le monde (broadcast)
...
{ // Permet au serveur d'afficher la chaine codée sans virgule entre les caractères (parceque c'est un tableau)
	var outputStr = '';
...
server.listen(8080, "192.168.0.26"); // Definie l'URL du serveur 